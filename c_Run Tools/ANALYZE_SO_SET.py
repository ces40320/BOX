...
def SO_XML_SET(root_dir, sub_name, APP, kg_bpm, trial_num, UpDown, task_num):
    ...
    for trial_num in range(1,3-1):
        for ud in range(0+1,2):
            for task_num in range(1,11):
                SO_XML_SET(root_dir, sub_name, APP, kg_bpm[condition], str(trial_num), UpDown[ud], str(task_num))
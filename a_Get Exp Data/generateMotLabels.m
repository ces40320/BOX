...
switch nFP
    ...
    case 4
        ...
        label{8} = 'ground_torque1_y';
        label{9} = 'ground_torque1_z';
        label{10} = 'ground_force2_vx';
        label{11} = 'ground_force2_vy';
        label{12} = 'ground_force2_vz';
        label{13} = 'ground_force2_px';
        label{14} = 'ground_force2_py';
        label{15} = 'ground_force2_pz';
        label{16} = 'ground_torque2_x';
        label{17} = 'ground_torque2_y';
        label{18} = 'ground_torque2_z';
        label{19} = 'hand_force3_vx';
        label{20} = 'hand_force3_vy';
        label{21} = 'hand_force3_vz';
        label{22} = 'hand_force3_px';
        label{23} = 'hand_force3_py';
        label{24} = 'hand_force3_pz';
        label{25} = 'hand_torque3_x';
        label{26} = 'hand_torque3_y';
        label{27} = 'hand_torque3_z';
        label{28} = 'hand_force4_vx';
        label{29} = 'hand_force4_vy';
        label{30} = 'hand_force4_vz';
        label{31} = 'hand_force4_px';
        label{32} = 'hand_force4_py';
        label{33} = 'hand_force4_pz';
        label{34} = 'hand_torque4_x';
        label{35} = 'hand_torque4_y';
        label{36} = 'hand_torque4_z';
...
%         label{36} = 'ground_torque4_z';
    ...
    case 5
        ...
        label{19} = 'ground_force3_vx';
        label{20} = 'ground_force3_vy';
        label{21} = 'ground_force3_vz';
        label{22} = 'ground_force3_px';
        label{23} = 'ground_force3_py';
        label{24} = 'ground_force3_pz';
        label{25} = 'ground_torque3_x';
        label{26} = 'ground_torque3_y';
        label{27} = 'ground_torque3_z';
        
        label{28} = 'ground_force4_vx';
        label{29} = 'ground_force4_vy';
        label{30} = 'ground_force4_vz';
        label{31} = 'ground_force4_px';
        label{32} = 'ground_force4_py';
        label{33} = 'ground_force4_pz';
        label{34} = 'ground_torque4_x';
        label{35} = 'ground_torque4_y';
        label{36} = 'ground_torque4_z';
        
        label{37} = 'ground_force5_vx';
        label{38} = 'ground_force5_vy';
        label{39} = 'ground_force5_vz';
        label{40} = 'ground_force5_px';
        label{41} = 'ground_force5_py';
        label{42} = 'ground_force5_pz';
        label{43} = 'ground_torque5_x';
        label{44} = 'ground_torque5_y';
        label{45} = 'ground_torque5_z';
    
    otherwise
        label=[];
        disp(' ')
        disp('More than 5 force platforms: add labels for mot file generations in function generateMotLabels.m')
end
